...
def shrink_data(train_data, train_labels, percent_shrink_data):
    ...
    return train_data_shrink, train_labels_shrink.tolist()


def augment_data_rot(train_data, train_labels):
    ''' 
    Operation: DESIGNED ON GRAYSCALE, but should work on rgb, doubles the number of training samples by randomly choosing
